...
Load<MeshBuffer> meshes(LoadTagDefault, []() {
    return new MeshBuffer(data_path(""));
});
...
Scene::Transform *hook_one_transformation = nullptr;

Scene::Camera *camera = nullptr;

Load<Scene> scene(LoadTagDefault, []() {
    Scene *ret = new Scene;
    ret->load(data_path(""), [](Scene &s, Scene::Transform *t, std::string const &m) {
        Scene::Object *obj = s.new_object(t);
        obj->program = vertex_color_program->program;
        obj->program_mvp_mat4 = vertex_color_program->object_to_clip_mat4;
        obj->program_mv_mat4x3 = vertex_color_program->normal_to_light_mat3;
